...
${flow} --enable-tuning=true --enable-opm-rst-file=true --shut-unsolvable-wells=0 --enable-well-operability-check=false  --solver-continue-on-convergence-failure=true --newton-max-iterations=40

"""Set the model parameters"""
co2eormodified  #Model (co2store/h2store)
...
PERMXY1 1000 PERMZ1 100 PORO1 0.3 THIC1 20 NZ1 3
...
% if control == 0:
${tperiod} ${tperiod} .01 0 ${qratew}
% else:
${tperiod} ${tperiod} .01 1 ${qrateg}
% endif
% endfor