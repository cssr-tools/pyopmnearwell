...
800 1 0  #Number of x- and z-cells [-] and exponential factor for the telescopic x-gridding (0 to use an equidistance partition)
...
1 1e-1 1e-1 0 ${rate*86400*998.108 / 6.}  #Divided by 6 since the domain has a angle of 60 degrees