...
400 1 0  #Number of x- and z-cells [-] and exponential factor for the telescopic x-gridding (0 to use an equidistance partition)
${2*radius} 1  1 #Well diameter [m], well transmiscibility (0 to use the computed one internally in Flow), and remove the smaller cells than the well diameter
1e7 40 1     #Pressure [Pa] on the top, uniform temperature [°], and initial phase in the reservoir (0 wetting, 1 non-wetting)
...
SWI5 0. SNI5 0.0 KRW5 1 KRN5 1 PRE5 0 NKRW5 2 NKRN5 2 HNPE5 2 THRE2 1e-4
...
1 1e-1 1e-1 1 ${rate*86400*1.86843 / 6.}  #Divided by 6 since the domain has a angle of 60 degrees