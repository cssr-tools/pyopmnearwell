...
25 4 0     #Number of x- and z-cells [-] and exponential factor for the telescopic x-gridding (0 to use an equidistance partition)
...
1 Killough 0.95 #Number of layers [-], hysteresis (1 to activate), and econ for the producer (for h2 models)
...
SWI5  0.1 SNI5  0.2 KRW5  .8 KRN5  .2 PRE5  .4e6 NKRW5 4 NKRN3 3.5 HNPE5 1.2 THRE5  1e-4 IGN1 0
