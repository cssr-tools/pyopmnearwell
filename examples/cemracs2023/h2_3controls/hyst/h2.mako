...
safu = [[0.1,0.1,0.8,0.2,4,4,3.5,1.2,1e-4,0,10000],[0.1,0.2,0.8,0.2,4,4,3.5,1.2,1e-4,0,10000]]

#Properties rock: 1) Kxy [mD], 2) Kz [mD], 3) phi [-], 4) thickness [m], and 5) no cells in the z dir [-] (entry per layer)
rock = [[700.15,700.15,0.25,20,4]]
...
% if control == 0:
[${tperiod},${tperiod},1,${-1*qrate},3.6e1,"0.01 0.1"],
% elif control == 1:
[${tperiod},${tperiod},1,${0*qrate},"0.01 0.1"],
% else:
[${tperiod},${tperiod},1,${qrate},"0.01 0.1"],
% endif
% endfor
