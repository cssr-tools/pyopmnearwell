...
SWI5  0.1 SNI5  0.2 KRW5  .8 KRN5  .2 PRE5  .4e6 NKRW5 4 NKRN3 4.5 HNPE5 1.2 THRE5  1e-4 IGN1 0
...
${tperiod} ${tperiod} .1 1 ${-1*qrate if control == 0 else qrate} ${3.6e6 if control == 0 else ' '}
% endfor
