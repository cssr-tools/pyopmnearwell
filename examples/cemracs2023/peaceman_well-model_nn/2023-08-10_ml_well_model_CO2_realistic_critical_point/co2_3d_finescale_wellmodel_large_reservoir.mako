...
1000  1       #Reservoir dimensions [m] (Lenght and height)
150 1 0        #Number of x- and z-cells [-] and exponential factor for the telescopic x-gridding (0 to use an equidistance partition)
...
10 1e-1 1e-1 1 ${rate * 6} # Multiplied by 6, since the model was trained on a cake of 1/6th size
