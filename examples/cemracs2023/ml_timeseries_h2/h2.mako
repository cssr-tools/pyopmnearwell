...
flow = "${flow} --enable-tuning=true --enable-opm-rst-file=true --linear-solver=cprw"
...
safu = [[0.1,0.1,0.8,0.2,4,4,3.5,1.2,1e-4,0],[0.1,0.1,0.8,0.2,40,4,3.5,1.2,1e-4,0],[0.1,0.1,0.8,0.2,4,4,3.5,1.2,1e-4,0],[0.1,0.1,0.8,0.2,40,4,3.5,1.2,1e-4,0]]
...
% endif
% endif
[365,365,10,1,-20000,3.6e1],
[365,365,30,1,-20000,3.6e1]]