...
safu = [[0.478,0,1,0.3,0,3,3,2,1e-5,0]${',[0.478,0.312,1,0.3,0,3,3,2,1e-5,0]]' if name != "nohysteresis" else ']'}
...
inj = [[7,7,7,1,1e6],[14,14,14,1,0],[7,7,7,1,1e6],[21,21,21,1,0],[7,7,7,1,1e6],[28,28,28,1,0],[7,7,7,1,1e6],[365,365,365,1,0]]
