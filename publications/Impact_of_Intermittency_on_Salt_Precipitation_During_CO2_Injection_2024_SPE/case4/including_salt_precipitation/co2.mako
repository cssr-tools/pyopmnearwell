...
saltprec dyncpres     #Model (co2store/h2store/co2eor/saltprec)
...
138 268 2153 1.75 0.35 1001 1e-2 power 1.75 0.35 1001 1.2e-2 0.5 #Ini salt conc [kg/m3], salt sol lim [kg/m3], prec salt den [kg/m3], gamma [-], phi_r [-], npoints [-], and threshold [-]  (all entries for saltprec)
