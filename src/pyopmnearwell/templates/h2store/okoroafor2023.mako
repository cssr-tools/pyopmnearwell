...
WCONINJE
% if dic['inj'][j][2]>0:
INJ0 GAS ${'OPEN' if dic['inj'][j][3]>0 else 'STOP'} RATE ${f"{abs(dic['inj'][j][3]) / 0.0850397:E}"} 1* 480 /
% else:
INJ0 WATER ${'OPEN' if dic['inj'][j][3]>0 else 'STOP'} RATE ${f"{abs(dic['inj'][j][3]) / 998.108:E}"} 1* 480 /
% endif
/
WCONPROD
