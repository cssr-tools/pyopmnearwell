...
% if dic['grid']=='core':
PRO1 G1 ${dic['nocells'][0]} ${1+mt.floor(dic['nocells'][2]/2)} 1* WATER 2* STOP /
% elif dic['grid'] != 'cartesian' and dic['grid'] != 'tensor3d' and dic['grid'] != 'coord3d' and dic['grid'] != 'cpg3d':
PRO1 G1 ${dic['nocells'][0]} 1 1* WATER 2* STOP /
% else:
PRO1 G1 1 1 1* WATER /
...
PRO4 ${'OPEN' if dic['inj'][j][3]>0 else 'SHUT'} BHP 5* ${dic['pressure']} /
% endif
% endif
/
% if dic['econ']>0:
