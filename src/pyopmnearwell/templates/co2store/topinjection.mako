...
% else:
INJ0 ${max(1, 1+mt.floor(dic['nocells'][1]/2))} ${max(1, 1+mt.floor(dic['nocells'][1]/2))} 1 1 'OPEN' 2* ${dic['diameter']} /
% endif
% else:
% if dic['grid']=='core':
...
WCONINJE
% if dic['inj'][j][3]>0:
INJ0 GAS ${'OPEN' if dic['inj'][j][4]>0 else 'SHUT'} RATE ${f"{dic['inj'][j][4] / 1.86843:E}"} 1* 480 /
% else:
