...
;
                  ...
                  ) const 
    {
            ...
            // Inside the domain
                ...
                for (int j = 0; j < num_cell_features; ++j) {
                    ...
                    // a bug?
                        ...
                        // Scale to mD and take log.
                        features[i][j] = Value(log10(1.01324997e15 * connection.Kh() / connection.connectionLength()));
                        }
        ...
        // Scale to mD
        const auto analytical_PI_scaled = Value(scaleFunction(analytical_PI * 1.01324997e15,
                                            xmin[${len(xmin)} - 1],
                                            xmax[${len(xmin)} - 1],
                                            feature_min,
                                            feature_max
        ...
        std::cout << "WI: " << pow(10, unscaleFunction(out.data_[0],${ymin}, ${ymax}, target_min, target_max)) << std::endl;
        std::cout << "WI_scaled: " << getValue(out.data_[0]) << std::endl;

        // Unscale and undo log before returning
        return pow(10, unscaleFunction(out.data_[0],${ymin}, ${ymax}, target_min, target_max));
    }
