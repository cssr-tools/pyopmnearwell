...
;
                  ...
                  ) const 
    {
            ...
            // Inside the domain
                ...
                for (int j = 0; j < num_cell_features; ++j) {
                    ...
                    // a bug?
                        ...
                        // Scale to mD.
                        features[i][j] = Value(1.01324997e15 * connection.Kh() / connection.connectionLength());
                        }
        ...
        std::cout << "analytical_PI_scaled: " << analytical_PI_scaled << std::endl;
        std::cout << "analytical_PI: " << analytical_PI * 1.01324997e15 << std::endl;
        std::cout << "analytical_PI m2: " << analytical_PI << std::endl;
